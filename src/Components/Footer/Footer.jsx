        ...
        <Container>
          ...
          "
            ...
            <div className="text-white space-y-3">
              <h1 className="font-medium text-[rgba(255,255,255,1)] text-[1.25rem]">Social Links</h1>
          ...
          <div className="text-center ">
            <small className='text-[rgba(250,250,250,1)] font-normal text-[1rem]'>Copyright © 2025 - All right reserved</small>
          </div>
        </Container>
      </footer>
    )
